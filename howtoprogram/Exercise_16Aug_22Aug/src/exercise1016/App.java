...
import exercise1016.App.listComparator;
...
//	nally, output the payment amount for each Payable object.
	...
	public static void main(String[] args) {
		...
		for (Payable currentPayable : listOfPayable) {
			...
			if (currentPayable instanceof BasePlusCommissionEmployee) {
				...
				java.util.List<Payable> list = new ArrayList<>();
			
				
				Comparator<Payable> comparator = new Comparator<Payable>() {
				...
				App app = new App();
				listComparator l = app.new listComparator();
				list.sort(l);
			}
	...
	public class listComparator implements Comparator<Payable>{
